...
myNRFLite::myNRFLite(uint8_t miso, uint8_t mosi, uint8_t sclk, uint8_t cs, uint8_t ce, Stream &serial)
{
  _serial = &serial;
...
uint8_t myNRFLite::init(uint8_t radioId, Bitrates bitrate, uint8_t channel)
{
  ...
  _spi->begin(_sclk, _miso, _mosi, _csnPin);
